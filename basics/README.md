...
- [基本类型](https://xcatliu.gitbooks.io/from-javascript-to-typescript/content/basics/primitive-types.html)
- [任意值（Any）](https://xcatliu.gitbooks.io/from-javascript-to-typescript/content/basics/any.md)
- [类型推论](https://xcatliu.gitbooks.io/from-javascript-to-typescript/content/basics/type-inference.md)
- [联合类型（Union Types）](https://xcatliu.gitbooks.io/from-javascript-to-typescript/content/basics/union-types.md)
