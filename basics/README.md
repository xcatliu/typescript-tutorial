...
本部分介绍了 TypeScript 中的常用类型，旨在让大家对 TypeScript 有个初步的理解。具体内容包括：

- [基本类型](https://xcatliu.gitbooks.io/from-javascript-to-typescript/content/basics/primitive-types.html)
- [一些基本概念](https://xcatliu.gitbooks.io/from-javascript-to-typescript/content/basics/basic-concepts.html)
