...
- 即使不显示的定义类型，也能够自动做出[类型推论](https://xcatliu.gitbooks.io/from-javascript-to-typescript/content/basics/basic-concepts.html#类型推论)
- 可以定义从简单到复杂的一切类型
...
- 短期可能会增加一些开发成本，毕竟要多写一些类型的定义，不过对于一个需要长期维护的项目，TypeScript 应该能够减少其维护成本（这条需要来源）
- 集成到构建流程的过程需要一些工作量
